                                    ...
                                    <div className="col-md-12">
                                        ...
                                        <div className="p-3 p-lg-5 border">
                                            <table className="table site-block-order-table mb-5">
                                                ...
                                                {cart.map((pro) => {
                                                    return (
                                                        ...
                                                        <>
                                                            <tbody>
                                                                <tr>
                                                                    <td> {pro.title} <strong className="mx-2">x</strong> {pro.quantity} </td>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td><h4>Total Price : $ <strong className="text-primary">{totalp}</strong></h4></td>
                                                    </tr>
                                                </tbody>
                                            ...
                                            <div className="border p-3 mb-5">
                                                <h3 className="h6 mb-0">
                                                    <NavLink to="/paypalbtn" className="btn border-2 btn-outline-primary btn-sm btn-block py-2 px-3 fs-5 fw-bold" aria-expanded="false" aria-controls="collapsepaypal">Paypal</NavLink></h3>
